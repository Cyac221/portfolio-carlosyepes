...
const TRANSLATIONS = {
  es: {
    ...
    hero_cta_projects: "Ver proyectos", hero_cta_contact: "Hablemos", hero_cta_cv: "⬇ Descargar CV",
    ...
    proj3_title: "Pipeline Medallion — Bronze/Silver/Gold",
    proj3_desc: "Diseño e implementación de un pipeline de datos con Arquitectura Medallion (Bronze → Silver → Gold) sobre datos de criptomonedas en tiempo real vía API de CoinGecko. Orquestado con Apache Airflow y procesado con PySpark",
    proj4_title: "Segmentación de Clientes con RFM + K-Means",
    proj4_desc: "Pipeline completo de segmentación de clientes sobre 500k transacciones reales de e-commerce. Construcción de métricas RFM, selección de K óptimo con Elbow Method y Silhouette Score, y visualización de clusters con PCA.",
    proj5_title: "A/B Testing — Análisis de Conversión",
    proj5_desc: "Test estadístico riguroso para determinar si una nueva landing page convierte mejor que la actual. Incluye power analysis, Z-test de proporciones y framework explícito para evitar p-hacking.",
    proj6_title: "Análisis de Cohortes — Retención de Clientes",
    proj6_desc: "Análisis de retención sobre 500k transacciones reales de e-commerce. Identifica cuándo y por qué se pierden los clientes, con un heatmap de cohortes mensuales y conclusiones accionables para marketing.",
    proj_code_btn: "Código",
  ...
  en: {
    ...
    hero_cta_projects: "View projects", hero_cta_contact: "Let's talk", hero_cta_cv: "⬇ Download CV",
    ...
    proj3_title: "Pipeline Medallion — Bronze/Silver/Gold",
    proj3_desc: "Designed and implemented a data pipeline using the Medallion Architecture (Bronze → Silver → Gold) to process real-time cryptocurrency data from the CoinGecko API. Orchestrated with Apache Airflow and processed using PySpark.",
    proj4_title: "Customer Segmentation with RFM + K-Means",
    proj4_desc: "End-to-end customer segmentation pipeline over 500k real e-commerce transactions. RFM feature engineering, optimal K selection via Elbow Method and Silhouette Score, and cluster visualization with PCA.",
    proj5_title: "A/B Testing — Conversion Rate Analysis",
    proj5_desc: "Rigorous statistical test to determine whether a new landing page converts better than the current one. Includes power analysis, Z-test for proportions, and an explicit framework to prevent p-hacking.",
    proj6_title: "Cohort Analysis — Customer Retention",
    proj6_desc: "Retention analysis over 500k real e-commerce transactions. Identifies when and why customers stop returning, with a monthly cohort heatmap and actionable marketing conclusions.",
    proj_code_btn: "Code",
